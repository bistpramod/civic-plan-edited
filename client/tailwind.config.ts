    ...
    extend: {
      ...
      colors: {
        ...
        civic: {
          ...
          crimson: "hsl(var(--civic-crimson))",
          "crimson-light": "hsl(var(--civic-crimson-light))",
        ...
        progress: {
          ...
          ongoing: "hsl(var(--progress-ongoing))",
          delayed: "hsl(var(--progress-delayed))",
          planned: "hsl(var(--progress-planned))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
